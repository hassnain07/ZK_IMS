              ...
              <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="category_mgm.php" method="post">
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Active Categories are shown here</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php echo $cat_arr['category_name']?>
                      </td>

                      <td>

                      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-default<?php echo $cat_arr['cat_id']?>"
    >
                Update Category
              </button>
                    ...
                    <div class="modal fade" id="modal-default<?php echo $cat_arr['cat_id']?>">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form action="category_mgm.php" method="post">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Category Name"
                                  name="category_name" value="<?php echo $cat_arr['category_name']?>" required>
                              </div>
                            </div>
                          </div>
                          <!-- /.form-group -->
                      ...
                      <div class="modal-footer justify-content-between">
                        <input type="hidden" name="action" value="<?php echo $cat_arr['cat_id']?>">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
