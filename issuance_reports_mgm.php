          ...
          <div class="card card-default">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <form action="issuance_reports_mgm.php" mehtod="get">
             ...
             ?>
              ...
              <form action="issuance_reports.php" method="post">
             ...
             ?>
                <?php
             if (isset($_GET['report_niche']) && $_GET['report_niche'] == "section") {
                ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="col-md-8">
                      <div class="form-group">
                        <label for="text">Select Section Name</label>
              
                        <select name="section_name" id="" class="form-control" required>
                          <option value="" class="form-control">Select section</option>
                          <?php
                      ...
                      while ($run_qry = $sel_qry->fetch(PDO::FETCH_ASSOC)) {
                          ...
                          ?>
                            <option value="<?php echo $run_qry['section_id']?>" class="form-control">
                              <?php echo $run_qry['section_name']?>
                            </option>
                            <?php
                ...
                <div class="row">
                  <div class="col-md-8 offset-2">
                    <center>
                      <input type="submit" name="report_by_section" class="btn btn-success btn-block" value="Get Report">
             ...
             ?>
                <?php
             if (isset($_GET['report_niche']) && $_GET['report_niche'] == "form_number") {
                ?>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="col-md-8">
                      <div class="form-group">
                        <label for="text">Enter Form Number</label>
                        <input type="text" class="form-control" name="form_number" placeholder="Enter Form Number">
                ...
                <div class="row">
                  <div class="col-md-8 offset-2">
                    <center>
                      <input type="submit" name="report_by_form" class="btn btn-success btn-block" value="Get Report">
