              ...
              <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <form action="particulars_mgm.php" method="post">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Unit Name"
                                  name="source_name" value="" required>
                              </div>
                            </div>
                          </div>
                          <!-- /.form-group -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Active Particular are shown here</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                ?>
                    ...
                    <tr>
                      ...
                      <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal-default<?php echo $unit_arr['id']?>"
                >
                Update Particular
              </button>
                    ...
                    <div class="modal fade" id="modal-default<?php echo $unit_arr['id']?>">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title">Update Particular</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
                    <form action="particulars_mgm.php" method="post">
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Particular Name"
                                  name="particular_name" value="<?php echo $unit_arr['particular_name']?>" required>
                              </div>
                            </div>
                          </div>
                          <!-- /.form-group -->
                      ...
                      <div class="modal-footer justify-content-between">
                        <input type="hidden" name="action" value="<?php echo $unit_arr['id']?>">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="submit" name="update_particular" class="btn btn-success">Update Particular</button>
                      </div>
                    </form>
                  </div>
                  <!-- /.modal-content -->
